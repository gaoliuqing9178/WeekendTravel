...
- 涉及前端 UI 的任务，evaluator 子代理只需要使用 Chrome DevTools MCP。Chrome DevTools MCP 负责模拟交互、状态等待、页面快照、console、network、DOM / accessibility 和视觉复核；Playwright MCP 可作为补充但不再强制要求。
